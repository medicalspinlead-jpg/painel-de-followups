...
export const API_GROUPS: EndpointGroup[] = [
    ...
    endpoints: [
      ...
      },
      {
        ...
        bodyParams: [
          ...
          { name: "waitDays", type: "number", description: "Dias de espera até reiniciar o ciclo (padrão: 7)." },
        ],
        exampleBody: { name: "Avaliação Estética", color: "bg-blue-500", active: true, waitDays: 7 },
        exampleResponse: {
          data: {
            id: "cat_123",
            name: "Avaliação Estética",
      ...
      },
      {
        ...
        bodyParams: [
          ...
          { name: "waitDays", type: "number", description: "Novos dias de espera até reiniciar o ciclo (>= 1)." },
        ],
  ...
  },
  {
    name: "Mensagens",
    description:
      "Mensagens de follow-up agendadas dentro de cada categoria. Sem limite: o dayOffset de cada mensagem define os 'dias' da categoria, e cada dia pode ter quantas mensagens quiser.",
    endpoints: [
      {
        id: "messages-list",
        method: "GET",
    ...
    endpoints: [
      ...
      },
      {
        ...
        bodyParams: [
          ...
          { name: "stage", type: "string", description: "Status inicial (padrão ativo)." },
        ...
        exampleResponse: {
          data: { id: "lead_1", name: "Maria Silva", stage: "ativo" },
          dispatched: 1,
        },
      },
      {
      ...
      },
      {
        ...
        exampleResponse: { data: { id: "lead_1", stage: "aguardando" } },
      },
      {
        id: "leads-delete",
        method: "DELETE",
